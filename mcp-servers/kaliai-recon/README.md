...
```
export KALIAI_ENGAGEMENT=test
export KALIAI_ENGAGEMENT_DIR=/path/to/engagements/test
pipx run --spec . kaliai-recon
```

Normally this is launched for you by `kaliai agent`, which sets those two
