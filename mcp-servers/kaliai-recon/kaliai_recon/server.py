"""kaliai-recon: an MCP server that lets an agent run a curated set of Kali
...
from .scope import ScopeError, log_call, require_in_scope

mcp = FastMCP("kaliai-recon")
...
def nmap_scan(
    ...
    try:
        ...
        log_call(None, "nmap_scan", target, argv, "refused", str(e))
        raise
